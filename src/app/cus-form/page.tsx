      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="flex justify-center w-full">
            <Button
              type="submit"
              className="w-32 py-3 bg-blue-600 text-white rounded-md transition-all duration-300 ease-in-out transform hover:bg-blue-700 hover:scale-100 hover:shadow-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
            >
              Submit
            </Button>
          </div>
